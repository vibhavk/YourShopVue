        ...
        <div class="row">
            ...
            <table class="table table-bordered table-striped p-2">
                ...
                <tbody>
                    ...
                    <CartLine v-for="line in lines" v-bind:key="line.product.id"
                        v-bind:line="line"
...
<script>
//v-bind:line="line" in CartLine rendering is used to pass prop to child, the CartLine here.    
import { mapState, mapMutations, mapGetters } from "vuex";
import CartLine from "./ShoppingCartLine";
export default {
    components: { CartLine },
    computed: {
        ...mapState({ lines: state => state.cart.lines }), //cart prefix is used due to separation
        ...mapGetters({  totalPrice : "cart/totalPrice"  }) 
    }, //note that the prefix approach is DIFFERENT FOR STATE AND GETTERS/MUTATIONS
    methods: {
        ...mapMutations({
