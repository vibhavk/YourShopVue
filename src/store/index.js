...
//Vuex allows only actions to perform async ops, therefore we define actions which then utilize _<name> mutators to change the state
//_page & _limit in URLs are defined by json-server package to filter data requested by client.